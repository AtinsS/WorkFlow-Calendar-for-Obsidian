...
### Хранение данных
Плагин хранит данные в JSON-формате в папке `calendar-data/` в корне хранилища. Это основной формат хранения — он обеспечивает быструю загрузку и бесшовную синхронизацию через:
- **WebDAV** (Яндекс.Диск, OneDrive и др.)
- **Obsidian Sync** / **Remotely Save**
- **iCloud** / **Google Drive**

> **Примечание:** JSON-файлы в `calendar-data/` — это основное хранилище плагина. Опциональная синхронизация с `.md` файлами (через настройку «Tasks plugin sync») предназначена для совместимости с плагинами [Tasks](https://github.com/obsidian-tasks-group/obsidian-tasks) и [Dataview](https://github.com/blacksmithgu/obsidian-dataview).
