...
**Направление:** по умолчанию двустороннее (оба направления), можно переключить на только отправку или только получение.

> После синхронизации задачи доступны как в плагине, так и в мобильном приложении SingularityApp.
